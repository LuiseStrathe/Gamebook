...
# [mode_name, description_short, description_long, description_img, giphy]
modes_info = [
    ["rounds", 
        
        "Play in rounds with your group.", 
        "Play in rounds with your group.\n\n \
    ...
    ["dice",
        ...
        "Roll the dice and achieve points in different categories.",
